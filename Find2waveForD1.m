Pt_Subs_input = 'D:\yunxia\ML\huigui\data for calibration D\input';%存放待处理数据的路径
...
Pt_Subs_output = 'D:\yunxia\ML\huigui\data for calibration D\output';%存放待处理数据的路径
...
for i=1:1:(fL-2)
    ...
    Local_output = strcat('D:\yunxia\ML\huigui\data for calibration D\output\',nm_vd_output);
    ...
    Local_input = strcat('D:\yunxia\ML\huigui\data for calibration D\input\',nm_vd_input);
...
%     end
    ...
    %--------------------------------------------------------------------
    savename = strcat('D:\yunxia\ML\huigui\resultD1\','R_matrix',nm_vd_output);
    savename = savename(1:end-5);
    save(savename,'R_matrix');
    savename = strcat('D:\yunxia\ML\huigui\resultD1\','R_max',nm_vd_output);
    savename = savename(1:end-5);
    save(savename,'R_max');
    savename = strcat('D:\yunxia\ML\huigui\resultD1\','wave_selected',nm_vd_output);
    savename = savename(1:end-5);
