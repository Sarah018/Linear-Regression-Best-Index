...
Pt_Subs = 'D:\yunxia\ML\huigui 老公\result_equ6';%存放待处理数据的路径
Nm_Vd = [];%存放文件名的结构体
...
for i=1:1:5
    ...
    Local = strcat('D:\yunxia\ML\huigui 老公\result_equ6\',nm_vd);
    load(Local);
    R_matrix;
%     %这里应该读进来就是R_matrix了
...
%     axis([400 1000 400 1000]);
    ...
    savename = strcat('D:\yunxia\ML\huigui 老公\figure_equ6\',nm_vd,'.jpeg');
