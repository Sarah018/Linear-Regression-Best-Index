...
%     end
    ...
    %--------------------------------------------------------------------
    savename = strcat('D:\yunxia\ML\huigui 老公\resultR1\','R_matrix',nm_vd_output);
    savename = savename(1:end-5);
    save(savename,'R_matrix');
    savename = strcat('D:\yunxia\ML\huigui 老公\resultR1\','R_max',nm_vd_output);
    savename = savename(1:end-5);
    save(savename,'R_max');
    savename = strcat('D:\yunxia\ML\huigui 老公\resultR1\','wave_selected',nm_vd_output);
    savename = savename(1:end-5);
